 ...
 *
 * Copy to your app's `src/sw.ts` and adjust LANDING_ROUTES / runtime caching
 * patterns to match your deployment.
 *
 * Works with `vite-plugin-pwa` in `injectManifest` mode — which is the default
 * from `@asteby/metacore-pwa/vite-plugin`.
 */
